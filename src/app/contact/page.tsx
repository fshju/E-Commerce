...
<div className="lg:flex justify-center text-center lg:text-left py-5 space-y-5 lg:space-y-0  lg:mr-14">
      <div className=" bg-white lg:shadow-2xl shadow-md w-72 h-auto mx-auto lg:mx-9 px-7 py-7 space-y-2">
        <h1 className="flex items-center gap-2 justify-center lg:justify-normal"> <div className=" border-8 border-red-500 bg-red-500 rounded-full"> <IoCallOutline className=" size-5" /></div> Call To Us</h1>
        <p>We are available 24/7, 7 days a week.</p>
        <p>Phone: +8801611112222</p>
        <br />
        <hr />
        <br />
        <h1 className="flex items-center justify-center lg:justify-normal gap-2"> <div className=" border-8 border-red-500 bg-red-500 rounded-full"><FaEnvelopeSquare className="size-5" /></div> Write To US</h1>
